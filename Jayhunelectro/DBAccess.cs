...
namespace Jayhunelectro
{
    class DBAccess
    {
        ...
        //public static string ip_address = "";////;Persist Security Info=False;server=192.168.43.93

        private static string strConnString = "datasource=127.0.0.1;port=3306;username=jayhun;password=2427651701;database=jayhunfilial";
